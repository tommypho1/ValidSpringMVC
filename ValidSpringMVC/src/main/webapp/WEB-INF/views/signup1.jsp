...
<form:form action="processSignup1" method="post" style="height: 332px" commandName="user1">
	Full Name<br />
	...
	<form:errors path="userId" cssClass="error1"/><br />
	<br />
	Password<br />
	...
	<form:errors path="age" cssClass="error1"/> <br />
	<br />
